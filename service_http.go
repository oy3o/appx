...
func (s *HttpService) Start(ctx context.Context) error {
	...
	handler := s.securityHeadersMiddleware(s.handler, s.certMgr != nil)
...
// These include X-Content-Type-Options, X-Frame-Options, and Strict-Transport-Security (if TLS is enabled).
