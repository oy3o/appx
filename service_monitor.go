...
func NewMonitorService(addr string, healthHandler http.Handler, mws ...func(http.Handler) http.Handler) *HttpService {
	...
	if healthHandler != nil {
		...
		mux.HandleFunc("/healthz", func(w http.ResponseWriter, r *http.Request) {
			// Performance optimization: Avoid heap allocation from []byte("string") cast.
			// io.WriteString leverages the underlying io.StringWriter interface of http.ResponseWriter.
			io.WriteString(w, "ok")
		})
	}
